...
# Adding Logo
st.sidebar.image(Retail_Hub_logo.add_logo(logo_path="./Logo/512x512empty.png", width=260, height=270)) 
st.sidebar.markdown('    **Powered by Innovation Explorer and OpenAI.**')
